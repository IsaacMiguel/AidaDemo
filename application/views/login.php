		...
		<hr>
			<div class="row">
				<form method="POST" action="<?php echo SITE_URL;?>index.php/login/auth">
					<label for="acount">Mi cuenta</label><input class="form-control" type="text" id="acount" name="acount" maxlength="15" placeholder="Acount...">
				<hr>
					<label for="password">Contraseña</label><input class="form-control" type="password" id="password" name="password" maxlength="15" placeholder="Password...">
				<hr>
